  ...
  return (
      ...
      <div className="space-y-4">
        <div className="border border-gray-200 p-4">
          <h2 className={currentStep>=1  ? "text-green-600" : "text-red-600"}>Step1: Pickup/Drop Off</h2>
        ...
        <div className="border border-gray-200 p-4">
          <h2 className={currentStep>=2  ? "text-green-600" : "text-red-600"}>
        ...
        <div className="border border-gray-200 p-4">
          <h2 className={currentStep>=3  ? "text-green-600" : "text-red-600"}>
            Step3: In Transit
          </h2>
        ...
        <div className="border border-gray-200 p-4">
          <h2 className={currentStep>=4 ? "text-green-500" : "text-red-500"}>
            Step4: Delivered
          </h2>
